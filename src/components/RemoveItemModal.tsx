...
export default function RemoveItemModal({ open, onClose }: Props) {
  ...
  return (
    <Modal isOpen={open} onClose={onClose} title="Items to Remove">
      ...
      <div className="mt-5 grid grid-cols-[2fr_1fr] gap-5">
        <p className="text-lg font-semibold text-black">To Remove</p>
